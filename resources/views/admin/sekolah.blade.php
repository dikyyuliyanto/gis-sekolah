        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('school.store') }}" method="POST" enctype="multipart/from-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="website" name="website"
                                @error('website') is invalid @enderror required>
                            @error('website')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
        ...
        <div class="modal fade" id="form-edit{{ $item->id_sekolah }}" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('school.update', ['id' => $item->id_sekolah]) }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="nama_sekolah">Nama sekolah</label>
                                <input type="text" class="form-control" id="nama_sekolah" name="nama_sekolah"
                            ...
                            <div class="form-group">
                                <label for="id_kecamatan">Kecamatan</label>
                                <select class="form-control" id="id_kecamatan" name="id_kecamatan">
                                    value="{{ $item->id_kecamatan }}"@error('id_kecamatan')
                                    is invalid
                                @enderror required>
                                @foreach ($kecamatan as $itemKecamatan)
                                    <option value="{{ $itemKecamatan->id_kecamatan }}">
                        ...
                        <div class="form-group">
                            <label for="website">Website Sekolah</label>
                            <input class="form-control" id="website" name="website"
                                value="{{ $item->website }}"@error('website') is invalid @enderror required>
                            @error('website')
                                is invalid
                            @enderror required>
                            @error('website')
    ...
    <div class="modal fade" id="konfirmasi-hapus-{{ $item->id_sekolah }}" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('school.destroy', ['id' => $item->id_sekolah]) }}" method="POST"
                        class="d-inline">
                        @csrf
                        @method('DELETE')
